...
```bash
node scripts/evaluation/run_question_search_gate.js --fixture data/eval/question_search_gold_9709_v1.json --report docs/reports/2026-06-04-9709-p2-w24-standard-001-search-gate-report.md --json-out docs/reports/2026-06-04-9709-p2-w24-standard-001-search-gate.json --psql-mode docker --psql-container supabase_db_ciecopilot-home
```

## Fixture

- Fixture path: `data/eval/question_search_gold_9709_v1.json`
- Generated at (UTC): `2026-06-04T07:25:05.795Z`
- Case count: `5`
...
| learning_question_search_projection_9709 | yes | 3132 | paper_question: 3121, imported_question: 11 |
| question_bank_9709 | yes | 3132 | paper_question: 3121, imported_question: 11 |
