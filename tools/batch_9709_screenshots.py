...
def main():
    parser = argparse.ArgumentParser(description="Batch screenshots for 9709 Mathematics papers")
    parser.add_argument("--paper", required=True, help="paper1|paper2|paper3|paper4|paper5|paper6")
    parser.add_argument("--dpi", type=int, default=400)
    parser.add_argument("--out-root", default="outputs/screenshots/9709")
    args = parser.parse_args()

    paper = args.paper.lower()
    paper_dir = Path("data") / "past-papers" / "9709Mathematics" / paper
