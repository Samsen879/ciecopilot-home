-- Add corpus-version filtering to hybrid_search_v2 without breaking positional callers.
-- This migration preserves the original argument order and appends p_corpus_versions
-- as the final optional parameter.
