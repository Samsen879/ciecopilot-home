...
```bash
node scripts/evaluation/run_question_search_gate.js --fixture data/eval/question_search_gold_9709_v1.json --report docs/reports/2026-06-01-9709-p6-s-standard-001-search-gate-report.md --json-out docs/reports/2026-06-01-9709-p6-s-standard-001-search-gate.json
```

## Fixture

- Fixture path: `data/eval/question_search_gold_9709_v1.json`
- Generated at (UTC): `2026-06-01T16:20:47.913Z`
- Case count: `5`
...
| learning_question_search_projection_9709 | yes | 2764 | paper_question: 2753, imported_question: 11 |
| question_bank_9709 | yes | 2764 | paper_question: 2753, imported_question: 11 |
