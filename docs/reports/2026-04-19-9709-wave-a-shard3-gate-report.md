...
```bash
node scripts/evaluation/run_question_search_gate.js --fixture data/eval/question_search_gold_9709_v1.json --report docs/reports/2026-04-19-9709-wave-a-shard3-gate-report.md --json-out docs/reports/2026-04-19-9709-wave-a-shard3-gate.json --psql-mode docker
```

## Fixture

- Fixture path: `data/eval/question_search_gold_9709_v1.json`
- Generated at (UTC): `2026-04-20T02:19:36.000Z`
- Case count: `5`
...
| mixed-ranking-paper-authority | topic=9709.p1.trigonometry, type=9709.trigonometry.identities, text~identity solve equation | b164f282-0727-4868-8d0e-d58866f7c095 | pass | 6/6 | present | no |
