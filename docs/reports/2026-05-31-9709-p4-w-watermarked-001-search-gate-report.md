...
```bash
node scripts/evaluation/run_question_search_gate.js --fixture data/eval/question_search_gold_9709_v1.json --report docs/reports/2026-05-31-9709-p4-w-watermarked-001-search-gate-report.md --json-out docs/reports/2026-05-31-9709-p4-w-watermarked-001-search-gate.json
```

## Fixture

- Fixture path: `data/eval/question_search_gold_9709_v1.json`
- Generated at (UTC): `2026-05-31T15:06:09.488Z`
- Case count: `5`
...
| learning_question_search_projection_9709 | yes | 2124 | paper_question: 2113, imported_question: 11 |
| question_bank_9709 | yes | 2124 | paper_question: 2113, imported_question: 11 |
