...
import { importQuestion } from '../lib/import/question-import-service.js';
...
export default async function handler(req, res) {
  ...
  try {
    const payload = await importQuestion(getServiceClient(), {
      userId: auth.userId,
      requestPath: req.path || '/api/learning/questions/import',
      body: req.body || {},
      idempotencyKey:
