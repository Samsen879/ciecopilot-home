...
-- Default dims 1536 (OpenAI text-embedding-3). If switching to Qwen/DashScope
-- models with 1024 dims (e.g. qwen-embedding, text-embedding-v3), alter this to vector(1024)
