...
```bash
node scripts/evaluation/run_question_search_gate.js --fixture data/eval/question_search_gold_9709_v1.json --report docs/reports/2026-04-19-9709-wave-a-shard2-gate-report.md --json-out docs/reports/2026-04-19-9709-wave-a-shard2-gate.json --psql-mode docker
```

## Fixture

- Fixture path: `data/eval/question_search_gold_9709_v1.json`
- Generated at (UTC): `2026-04-20T01:05:33.484Z`
- Case count: `5`
...
| learning_question_search_projection_9709 | yes | 48 | paper_question: 37, imported_question: 11 |
| question_bank_9709 | yes | 48 | paper_question: 37, imported_question: 11 |
