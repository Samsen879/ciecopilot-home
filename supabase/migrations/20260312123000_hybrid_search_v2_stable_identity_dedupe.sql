-- Replace full-source_ref dedupe with stable source identity dedupe.
-- Keep dense/key pool generation and RRF fusion intact, then dedupe after fusion
-- using version priority across logically identical chunks.
