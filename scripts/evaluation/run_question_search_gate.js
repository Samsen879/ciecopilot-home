...
function buildResidualRisks(environment, caseResults, gate) {
  ...
  const projection9709 = environment?.surfaces?.learning_question_search_projection_9709 || {};
...
export function renderQuestionSearchGateReport({
  ...
  const surfaceRows = [
    ...
    [
      ...
      'yes',
      environment?.surfaces?.learning_question_search_projection_9709?.total ?? 'n/a',
      `paper_question: ${environment?.surfaces?.learning_question_search_projection_9709?.paper_question ?? 'n/a'}, imported_question: ${environment?.surfaces?.learning_question_search_projection_9709?.imported_question ?? 'n/a'}`,
    ],
    [
      'question_bank_9709',
      'yes',
