# 9709 p4_w_watermarked_001 authority layer

Verdict: created a shard-scoped P4 authority layer for `p4_w_watermarked_001`. This uses component-scoped `9709.p4.*` runtime seed nodes and a 21-row authority sidecar. It does not claim full 9709 production readiness.

## Artifacts

- authority sidecar: `data/manifests/9709_p4_w_watermarked_001_authority_sidecar_v1.json`
- runtime seed: `data/curriculum/9709_question_search_recovery_nodes_with_p2_p4_v1.json`
- machine-readable report: `docs/reports/2026-05-31-9709-p4-w-watermarked-001-authority-layer.json`

## Scope

- shard: `p4_w_watermarked_001`
- rows: `21`
- source manifest: `data/manifests/9709_p4_w_watermarked_001_page_chain_surface_v1.json`
- projection evidence: `docs/reports/2026-05-31-9709-p4-w-watermarked-001-page-chain-projection.json`
...
This authority layer is shard-scoped. It authorizes `p4_w_watermarked_001` rows for the local ready-batch path only after the evidence/visual review gates have passed. It is not a statement that all Paper 4 or all 9709 rows are production-ready.
