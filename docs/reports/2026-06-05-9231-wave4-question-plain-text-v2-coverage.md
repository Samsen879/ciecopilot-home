...
- JSON artifact: docs/reports/2026-06-05-9231-wave4-question-plain-text-v2.json
...
| production rows | 191 |
| v2 rows | 191 |
| normalized plain text rows | 191 |
| strict text-only ready rows | 125 |
| image-context rows with assets | 66/66 |
| diagram rows | 9 |
| table-heavy rows | 57 |
| rows with math expressions | 116 |
| formula-dense rows with math expressions | 116/118 |
...
| 9231_wave1_surface_v1 | 191 | 191 | 125 | 66/66 | 116/118 | 2 | 0 | 0 | 0 | 191 |
