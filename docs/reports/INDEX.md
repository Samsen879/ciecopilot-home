...
- `2026-04-16-9709-qwen-wave1-execution-report.md` - issue `#198` execution-policy freeze for the deterministic `9709` wave-1 pilot, covering the red baseline posture, pilot manifest/curriculum seeds, router/output contracts, and the frozen region/base URL/non-thinking policy.
