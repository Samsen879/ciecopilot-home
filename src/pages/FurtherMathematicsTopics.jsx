...
import { ChevronDown, ChevronRight, BookOpen, Target, Zap, BarChart3, Grid, List, ArrowLeft } from "lucide-react";
...
const FurtherMathematicsTopics = () => {
  ...
  const paperData = {
    ...
    'fs': {
      ...
      data: fsData["9231_Paper_4_Further_Statistics"] || [],
      icon: BarChart3,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-violet-50/20 pt-20">
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <div className="text-left">
              ...
              <p className="text-xl text-gray-600 mt-2">
                CIE A Level Further Mathematics
              </p>
            </div>
          </div>
          
          <p className="text-lg text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Advanced mathematical concepts including Further Pure Mathematics, Further Mechanics, and Further Statistics
          </p>
                  ...
                  {paper.data.map((topic, topicIndex) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full p-6 text-left hover:bg-gray-50/50 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-inset"
                      >
                                  ...
                                  {card.details && (
                                    <div className="space-y-2">
                                      {card.details.map((detail, detailIndex) => (
                                        ...
                                        >
                                          <div className="flex items-center justify-center w-5 h-5 bg-purple-100 rounded-full mt-0.5 flex-shrink-0">
        ...
        <motion.div
          ...
          className="mt-16 bg-gradient-to-r from-purple-600 to-violet-600 rounded-2xl p-8 text-center text-white shadow-lg"
        >
          <h3 className="text-2xl font-bold mb-4">
            Complete Further Mathematics (9231) Coverage
          </h3>
          <p className="text-purple-100 mb-6 leading-relaxed max-w-2xl mx-auto">
            Advanced mathematical concepts covering further pure mathematics, mechanics, and statistics. 
...
export default FurtherMathematicsTopics;