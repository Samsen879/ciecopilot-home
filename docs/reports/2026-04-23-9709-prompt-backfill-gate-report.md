...
```bash
node scripts/evaluation/run_question_search_gate.js --fixture data/eval/question_search_gold_9709_v1.json --report docs/reports/2026-04-23-9709-prompt-backfill-gate-report.md --json-out docs/reports/2026-04-23-9709-prompt-backfill-gate.json --psql-mode docker
```

## Fixture

- Fixture path: `data/eval/question_search_gold_9709_v1.json`
- Generated at (UTC): `2026-04-22T18:04:49.806Z`
- Case count: `5`
...
| mixed-ranking-paper-authority | topic=9709.p1.trigonometry, type=9709.trigonometry.identities, text~identity solve equation | ready | 698300e0-1c5f-4fe4-86cd-d983cdbb2eaa | pass | 6/6 | present | no |
